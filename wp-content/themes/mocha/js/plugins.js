...
;(function($, undefined) {
	'use strict';
	// mocha image data-uri bypasses webkit log warning (thx doug jones)
	var MOCHA = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
	...
	$.fn.imagesLoaded = function( callback ) {
		...
		function imgLoaded( img, isBroken ) {
			// don't proceed if MOCHA image, or image is already loaded
			if ( img.src === MOCHA || $.inArray( img, loaded ) !== -1 ) {
				return;
			}
