...
if (count($list)>0){
?>
<div class="view-all"><a href="<?php echo get_category_link($category) ?>"><?php esc_html_e( 'View All', 'mocha' );?><i class="icon-caret-right"></i></a></div>
					...
					<div class="item-content">
						<?php 
							if ( preg_match('/<!--more(.*?)?-->/', $post->post_content, $matches) ) {
								...
								$content = self::mocha_trim_words($post->post_content, $length, ' ');
							}
