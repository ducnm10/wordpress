			...
			<li class="widget-post item-<?php echo $key;?>">
				<div class="widget-post-inner">			
					<div class="widget-thumb">
						<a href="<?php echo get_permalink($post->ID)?>" title="<?php echo esc_attr( $post->post_title );?>"><?php echo get_the_post_thumbnail($post->ID, 'mocha_popular_post');?></a>
					</div>
				<?php } ?>
					<div class="item-title">
							...
							<div class="item-meta">
								<span class="author"><?php esc_html_e('By', 'mocha'); ?> <?php the_author_posts_link(); ?></span>	
							</div>
					</div>
				</div>
			</li>
