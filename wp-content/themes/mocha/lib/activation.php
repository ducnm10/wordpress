					...
					<li>
						<label for="update_theme" class="clearfix">
							...
							<div class="activation-content">
								<h3><?php esc_html_e( 'New Installation (Install theme with demo data)', 'mocha' ); ?></h3>
								<div class="activation-desc"><?php esc_html_e( 'Install your theme with our sample data.
	Use our sample data for all files, products, images, configurations... that you will have a complete website that is exactly same as our Demo.', 'mocha' ); ?></div>
							</div>
						</label>
					</li>
					<li>
						<label for="upgrade_theme" class="clearfix">
							...
							<div class="activation-content">
								<h3><?php esc_html_e( 'Upgrade Theme (Install theme only)', 'mocha' ); ?></h3>
								<div class="activation-desc"><?php esc_html_e( "Install your theme with your data.
	Your files, products, images, configurations... aren't change. You will get the Mocha theme layouts and pages.", 'mocha' ); ?></div>
							</div>
						</label>
					</li>
				</ul>
