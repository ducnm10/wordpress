...
function zr_import_files() { 
	return array(
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-2/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-4/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-3/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-6/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-5/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-7/' ),
    ),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-8/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/furniture-store-2/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-9/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-10/' ),
		),
		...
		array(
			...
			'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately. This import maybe finish on 10-15 minutes', 'mocha' ),
			'preview_url'                  => esc_url( 'http://demo.wpthemego.com/themes/zr_mocha/home-page-11/' ),
		),
	);
}
