...
if ( ! class_exists( 'WC_Currency_Converter' ) ) {
	...
	class WC_Currency_Converter {
		...
		public function __construct() {
			$this->settings = array(
				array(
					'name' => esc_html__( 'Open Exchange Rate API', 'mocha' ),
					'type' => 'title',
					'desc' => '',
		...
		public function admin_notice_wrong_key() {
			?>
			<div class="error">
				<p><?php esc_html_e( 'WooCommerce Currency Converter: Incorrect key entered!', 'mocha' ); ?></p>
			</div>
		<?php
		}
		...
		public function load_plugin_textdomain() {
			load_plugin_textdomain( 'mocha', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
		}
			...
			if ( $currencies ) {
				...
				if ( ! empty( $instance['currency_display'] ) && 'select' === $instance['currency_display'] ) {
					...
					if ( ! empty( $instance['show_reset'] ) ) {
						$html .= ' <a href="#" class="wc-currency-converter-reset reset">' . esc_html__( 'Reset', 'mocha' ) . '</a>';
					}
					...
					if ( ! empty( $instance['show_reset'] ) ) {
						$html .= '<li><a href="#" class="wc-currency-converter-reset reset">' . esc_html__( 'Reset', 'mocha' ) . '</a></li>';
					}
