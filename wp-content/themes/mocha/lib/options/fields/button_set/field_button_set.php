<?php
class Mocha_Options_button_set extends Mocha_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('mocha-opts-jquery-ui-css');

		wp_enqueue_script(
			'mocha-opts-field-button_set-js', 
			MOCHA_OPTIONS_URL.'fields/button_set/field_button_set.js', 
