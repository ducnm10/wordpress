...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('category') ); ?>"><?php esc_html_e('Category Name', 'mocha')?></label>
	<br />
	<?php echo $this->category_select('category', array('allow_select_all' => true), $categoryid); ?>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('orderby') ); ?>"><?php esc_html_e('Orderby', 'mocha')?></label>
	<br />
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('order') ); ?>"><?php esc_html_e('Order', 'mocha')?></label>
	<br />
	<select class="widefat"
		...
		<?php } ?>>
			<?php esc_html_e('Descending', 'mocha')?>
		</option>
		<option value="ASC" <?php if ($order=='ASC'){?> selected="selected"
		<?php } ?>>
			<?php esc_html_e('Ascending', 'mocha')?>
		</option>
	</select>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('numberposts') ); ?>"><?php esc_html_e('Number of Posts', 'mocha')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('include') ); ?>"><?php esc_html_e('Include Posts ID', 'mocha')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('exclude') ); ?>"><?php esc_html_e('Exclude Posts ID', 'mocha')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('length') ); ?>"><?php esc_html_e('Excerpt length (in words): ', 'mocha')?></label>
	<br />
	<input class="widefat"
