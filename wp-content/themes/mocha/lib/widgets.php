...
class Mocha_Social_Widget extends WP_Widget{
	...
	function __construct(){
		$widget_ops = array('classname' => 'zr_social', 'description' => esc_html__('SW Social Networks', 'mocha'));
		parent::__construct('zr_social', esc_html__('SW Social', 'mocha'), $widget_ops);
