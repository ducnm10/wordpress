<?php 
	...
	$mocha_bclass = ( has_post_thumbnail() ) ? '' : 'no-thumb ';
	$mocha_bclass .= 'clearfix';
?>
	<div id="post-<?php the_ID();?>" <?php post_class( $mocha_bclass ); ?>>
		<div class="entry clearfix">
			...
			<div class="entry-content">				
				<div class="content-top clearfix">
					...
					<div class="entry-meta">
							...
							<span class="entry-comment">
								<a href="<?php comments_link(); ?>"><i class="fa fa-comments"></i><?php echo $post-> comment_count . ( ($post-> comment_count) > 1 ? esc_html__('  Comments', 'mocha') : esc_html__('  Comment', 'mocha') ); ?></a>
							</span>
							<?php if(has_tag()) :?>
				...
				<div class="readmore"><a href="<?php echo get_permalink($post->ID)?>"><i class="fa fa-caret-right"></i><?php esc_html_e('Read More', 'mocha'); ?></a></div>
			</div>
			<?php } else { ?>
			<div class="entry-thumb">	
